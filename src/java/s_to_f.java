 ...
 * @author Harsh Jain
 */
@WebServlet(urlPatterns = {"/s_to_f"})
public class s_to_f extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String qr="insert into messages(msg,sid,fid) values(?,?,?)";
            PreparedStatement ps=con.prepareStatement(qr);
            ps.setString(1,msg);
            ps.setString(2, student_name);
            ps.setString(3,faculty_name);
            ps.executeUpdate();
            response.sendRedirect("chat_student.jsp");
//            ResultSet rs=ps.executeQuery();
            
        } catch (ClassNotFoundException | SQLException ex) {
            Logger.getLogger(s_to_f.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
