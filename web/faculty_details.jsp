<%-- 
    ...
    Created on : 13 Oct, 2018, 6:00:58 PM
    Author     : Harsh Jain
--%>
...
//      %>
                    <div class="divide" style="left: 30%; width: 50%; top: 20%; height: 75%; right: 20%; overflow-x: auto; overflow-y: auto">
                        ...
                        <form action="fetch_faculty_details"> 
                             <%
                             if(status.equals("F"))
//        
                            {
//                         %>
        <font style="color: red;margin-left: 80px;margin-bottom: 5px">Faculty does not exist!!</font>
        <%  
                }else{
                        }
        %>
                            <input type="text" name="faculty_username" placeholder="Username">
                        <br>
                        <br>
