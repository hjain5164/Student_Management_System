<%-- 
    Document   : enroll_student
    Created on : 6 Oct, 2018, 11:39:20 PM
    Author     : Harsh Jain
--%>
...
<!--                                <tr>
                                    <td>
                                        <p style="font-family: sans-serif; font-size: 20px; color: darkslategrey"> <strong>Upload Image(200x200) :</strong></p> 
                                    </td>
                                    <td><input type="file" name="ImageFile" id="ImageFile"><br>
                            </td>
                                </tr>-->
